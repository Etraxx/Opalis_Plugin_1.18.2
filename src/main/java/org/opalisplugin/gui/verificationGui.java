...
public class verificationGui {
    public static Inventory verificationGui(String answer_string) {
        ...
        ItemStack red = new ItemStack(Material.WHITE_STAINED_GLASS_PANE,1,(short)14);
        ItemStack green = new ItemStack(Material.WHITE_STAINED_GLASS_PANE, 1, (short) 5);
        ItemStack answer = new ItemBuilder(Material.COMMAND_BLOCK).setName( "§f♦ §c§l§o" + answer_string + " §f♦").toItemStack();

        inv.setItem(13, answer);
        inv.setItem(22, answer);
        inv.setItem(31, answer);

        ItemStack glass = new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName("").toItemStack();
        inv.setItem(0, glass);
        inv.setItem(8, glass);
