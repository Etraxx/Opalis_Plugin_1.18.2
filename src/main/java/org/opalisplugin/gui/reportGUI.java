...
public class reportGUI {
    public static Inventory report(Player target) {
        ...
        //PLAYERHEAD
        ItemStack Playerhead = new ItemBuilder(Material.SKELETON_SKULL).setSkullOwner(target.getDisplayName()).setName("§6§lJoueur cible : " + target.getDisplayName() ).toItemStack();


        ItemStack glass = new ItemBuilder(Material.WHITE_STAINED_GLASS).setName("").toItemStack();
